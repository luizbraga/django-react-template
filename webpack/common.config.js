...
const PATHS = {
    app: path.join(__dirname, '../webserver/static'),
    build: path.join(__dirname, '../webserver/static_dist')
};
...
const basePath = path.resolve(__dirname, '../webserver/static/');
...
const common = {
    ...
    plugins: [
        ...
        new HtmlWebpackPlugin({
            template: path.join(__dirname, '../webserver/static/index.html'),
            hash: true,
            chunks: ['vendor', 'app'],
